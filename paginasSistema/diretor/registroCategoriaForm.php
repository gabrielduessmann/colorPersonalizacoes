...
<head>
  ...
  <script src="../../js/diretor/registroCategoria.js"></script>
</head>
...
<body>
	...
	<main id="conteudo">
		...
		<fieldset class="fieldsets">
			...
			<form action="registraCategoria.php" method="POST" id="formRegistroCategoria" onsubmit="return validarCampos()" >
	...
	<tr>
		...
		<td class="linhaBotoes">
			...
			<form action="excluiCategoria.php" method="POST">
