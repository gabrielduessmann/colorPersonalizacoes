...
<?php include("menuDiretor.php"); ?>
	...
	<main id="conteudo">
		...
		<form action="registraUsuario.php" method="POST" onsubmit="return validarCampos('sim')" id="formRegistroUsuario">
...
<br><br>
    ...
    <legend class="legend">Consulta de Usuários</legend>
		...
		<form action="registroUsuarioForm.php" method="GET" id="formConsultaUsuario">
